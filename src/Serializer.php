...
{
    private const array KNOWN_INTERFACES = [
        UpdateInterface::class,
        WebhookInfoInterface::class,
        UserInterface::class,
        ChatInterface::class,
        ChatFullInfoInterface::class,
        MessageInterface::class,
        MessageIdInterface::class,
        InaccessibleMessageInterface::class,
        MessageEntityInterface::class,
        TextQuoteInterface::class,
        ExternalReplyInfoInterface::class,
        ReplyParametersInterface::class,
        MessageOriginUserInterface::class,
        MessageOriginHiddenUserInterface::class,
        MessageOriginChatInterface::class,
        MessageOriginChannelInterface::class,
        PhotoSizeInterface::class,
        ...
        BackgroundFillFreeformGradientInterface::class,
        BackgroundTypeFillInterface::class,
        BackgroundTypeWallpaperInterface::class,
        ...
        ForumTopicReopenedInterface::class,
        GeneralForumTopicHiddenInterface::class,
        GeneralForumTopicUnhiddenInterface::class,
        SharedUserInterface::class,
        UsersSharedInterface::class,
        ChatSharedInterface::class,
        WriteAccessAllowedInterface::class,
        VideoChatScheduledInterface::class,
        VideoChatStartedInterface::class,
        VideoChatEndedInterface::class,
        VideoChatParticipantsInvitedInterface::class,
        PaidMessagePriceChangedInterface::class,
        DirectMessagePriceChangedInterface::class,
        SuggestedPostApprovedInterface::class,
        SuggestedPostApprovalFailedInterface::class,
        SuggestedPostDeclinedInterface::class,
        SuggestedPostPaidInterface::class,
        SuggestedPostRefundedInterface::class,
        GiveawayCreatedInterface::class,
        GiveawayInterface::class,
        GiveawayWinnersInterface::class,
        GiveawayCompletedInterface::class,
        LinkPreviewOptionsInterface::class,
        SuggestedPostPriceInterface::class,
        SuggestedPostInfoInterface::class,
        ...
        InlineKeyboardButtonInterface::class,
        LoginUrlInterface::class,
        SwitchInlineQueryChosenChatInterface::class,
        ...
        ChatMemberUpdatedInterface::class,
        ChatMemberOwnerInterface::class,
        ChatMemberAdministratorInterface::class,
        ChatMemberMemberInterface::class,
        ChatMemberRestrictedInterface::class,
        ChatMemberLeftInterface::class,
        ChatMemberBannedInterface::class,
        ChatJoinRequestInterface::class,
        ChatPermissionsInterface::class,
        BirthdateInterface::class,
        BusinessIntroInterface::class,
        BusinessLocationInterface::class,
        BusinessOpeningHoursIntervalInterface::class,
        BusinessOpeningHoursInterface::class,
        UserRatingInterface::class,
        StoryAreaPositionInterface::class,
        LocationAddressInterface::class,
        StoryAreaTypeLocationInterface::class,
        StoryAreaTypeSuggestedReactionInterface::class,
        StoryAreaTypeLinkInterface::class,
        StoryAreaTypeWeatherInterface::class,
        StoryAreaTypeUniqueGiftInterface::class,
        StoryAreaInterface::class,
        ChatLocationInterface::class,
        ReactionTypeEmojiInterface::class,
        ReactionTypeCustomEmojiInterface::class,
        ReactionTypePaidInterface::class,
        ReactionCountInterface::class,
        MessageReactionUpdatedInterface::class,
        MessageReactionCountUpdatedInterface::class,
        ForumTopicInterface::class,
        GiftBackgroundInterface::class,
        GiftInterface::class,
        GiftsInterface::class,
        UniqueGiftModelInterface::class,
        UniqueGiftSymbolInterface::class,
        UniqueGiftBackdropColorsInterface::class,
        UniqueGiftBackdropInterface::class,
        UniqueGiftColorsInterface::class,
        UniqueGiftInterface::class,
        GiftInfoInterface::class,
        UniqueGiftInfoInterface::class,
        ...
        BotCommandScopeDefaultInterface::class,
        BotCommandScopeAllPrivateChatsInterface::class,
        BotCommandScopeAllGroupChatsInterface::class,
        BotCommandScopeAllChatAdministratorsInterface::class,
        BotCommandScopeChatInterface::class,
        BotCommandScopeChatAdministratorsInterface::class,
        BotCommandScopeChatMemberInterface::class,
        BotNameInterface::class,
        BotDescriptionInterface::class,
        BotShortDescriptionInterface::class,
        MenuButtonCommandsInterface::class,
        MenuButtonWebAppInterface::class,
        MenuButtonDefaultInterface::class,
        ChatBoostSourcePremiumInterface::class,
        ChatBoostSourceGiftCodeInterface::class,
        ChatBoostSourceGiveawayInterface::class,
        ...
        InputProfilePhotoAnimatedInterface::class,
        InputStoryContentPhotoInterface::class,
        InputStoryContentVideoInterface::class,
        StickerInterface::class,
        ...
        InlineQueryResultPhotoInterface::class,
        InlineQueryResultGifInterface::class,
        InlineQueryResultMpeg4GifInterface::class,
        InlineQueryResultVideoInterface::class,
        InlineQueryResultAudioInterface::class,
        InlineQueryResultVoiceInterface::class,
        InlineQueryResultDocumentInterface::class,
        InlineQueryResultLocationInterface::class,
        InlineQueryResultVenueInterface::class,
        InlineQueryResultContactInterface::class,
        InlineQueryResultGameInterface::class,
        InlineQueryResultCachedPhotoInterface::class,
        InlineQueryResultCachedGifInterface::class,
        InlineQueryResultCachedMpeg4GifInterface::class,
        InlineQueryResultCachedStickerInterface::class,
        InlineQueryResultCachedDocumentInterface::class,
        InlineQueryResultCachedVideoInterface::class,
        ...
        OrderInfoInterface::class,
        ShippingOptionInterface::class,
        SuccessfulPaymentInterface::class,
        RefundedPaymentInterface::class,
        ShippingQueryInterface::class,
        PreCheckoutQueryInterface::class,
        PaidMediaPurchasedInterface::class,
        RevenueWithdrawalStatePendingInterface::class,
        RevenueWithdrawalStateSucceededInterface::class,
        RevenueWithdrawalStateFailedInterface::class,
        AffiliateInfoInterface::class,
        TransactionPartnerUserInterface::class,
        TransactionPartnerChatInterface::class,
        TransactionPartnerAffiliateProgramInterface::class,
        TransactionPartnerFragmentInterface::class,
        TransactionPartnerTelegramAdsInterface::class,
        TransactionPartnerTelegramApiInterface::class,
        TransactionPartnerOtherInterface::class,
        StarTransactionInterface::class,
        StarTransactionsInterface::class,
        PassportDataInterface::class,
        PassportFileInterface::class,
        EncryptedPassportElementInterface::class,
        EncryptedCredentialsInterface::class,
        PassportElementErrorDataFieldInterface::class,
        PassportElementErrorFrontSideInterface::class,
        PassportElementErrorReverseSideInterface::class,
        PassportElementErrorSelfieInterface::class,
        PassportElementErrorFileInterface::class,
        PassportElementErrorFilesInterface::class,
        PassportElementErrorTranslationFileInterface::class,
        PassportElementErrorTranslationFilesInterface::class,
        PassportElementErrorUnspecifiedInterface::class,
        GameInterface::class,
        CallbackGameInterface::class,
        GameHighScoreInterface::class,
    ];
    ...
    public function __construct(
         ...
         */
        private array $customTypesMapping = [],
    ) {
    }
    ...
    private function resolveAndDenormalizeSubclass(array $data, string $originalType): TypeInterface
    {
