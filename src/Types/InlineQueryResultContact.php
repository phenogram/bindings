 ...
 */
class InlineQueryResultContact extends InlineQueryResult implements Interfaces\InlineQueryResultContactInterface
{
    /**
     ...
     * @param InputMessageContentInterface|null  $inputMessageContent Optional. Content of the message to be sent instead of the contact
