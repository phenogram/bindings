 ...
 */
class InlineQueryResultVideo extends InlineQueryResult implements Interfaces\InlineQueryResultVideoInterface
{
    /**
     ...
     * @param InputMessageContentInterface|null  $inputMessageContent   Optional. Content of the message to be sent instead of the video. This field is required if InlineQueryResultVideo is used to send an HTML-page as a result (e.g., a YouTube video).
     */
