...
class InputChecklist implements Interfaces\InputChecklistInterface
{
     ...
     * @param array<MessageEntityInterface>|null $titleEntities            Optional. List of special entities that appear in the title, which can be specified instead of parse_mode. Currently, only bold, italic, underline, strikethrough, spoiler, custom_emoji, and date_time entities are allowed.
