...
class InputChecklistTask implements Interfaces\InputChecklistTaskInterface
{
     ...
     * @param array<MessageEntityInterface>|null $textEntities Optional. List of special entities that appear in the text, which can be specified instead of parse_mode. Currently, only bold, italic, underline, strikethrough, spoiler, custom_emoji, and date_time entities are allowed.
     */
