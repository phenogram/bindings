 ...
 */
class Audio implements Interfaces\AudioInterface
{
    /**
     ...
     * @param PhotoSizeInterface|null $thumbnail    Optional. Thumbnail of the album cover to which the music file belongs
     */
