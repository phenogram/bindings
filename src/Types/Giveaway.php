 ...
 */
class Giveaway implements Interfaces\GiveawayInterface
{
    /**
     * @param array<ChatInterface> $chats                         The list of chats which the user must join to participate in the giveaway
