 ...
 */
class InlineQueryResultVenue extends InlineQueryResult implements Interfaces\InlineQueryResultVenueInterface
{
    /**
     ...
     * @param InputMessageContentInterface|null  $inputMessageContent Optional. Content of the message to be sent instead of the venue
