...
interface WebhookInfoInterface extends TypeInterface
{
    ...
    public ?string $lastErrorMessage { set; }
    ...
    public ?int $lastSynchronizationErrorDate { set; }
    ...
    public ?array $allowedUpdates { set; }
}
