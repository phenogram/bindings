...
interface BusinessBotRightsInterface extends TypeInterface
{
    ...
    public ?bool $canChangeGiftSettings { set; }
    ...
    public ?bool $canViewGiftsAndStars { set; }
    ...
    public ?bool $canConvertGiftsToStars { set; }
    ...
    public ?bool $canTransferAndUpgradeGifts { set; }
    ...
    public ?bool $canTransferStars { set; }
    ...
    public ?bool $canManageStories { set; }
}
