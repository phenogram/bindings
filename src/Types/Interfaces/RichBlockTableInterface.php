 ...
 */
interface RichBlockTableInterface extends TypeInterface
{
    ...
    /** @var bool|null $isBordered Optional. True, if the table has borders */
    public ?bool $isBordered { set; get; }

    /** @var bool|null $isStriped Optional. True, if the table is striped */
