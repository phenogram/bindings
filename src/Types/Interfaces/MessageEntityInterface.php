...
interface MessageEntityInterface extends TypeInterface
{
    ...
    /** @var int|null $unixTime Optional. For “date_time” only, the Unix time associated with the entity */
    public ?int $unixTime { set; get; }

    /** @var string|null $dateTimeFormat Optional. For “date_time” only, the string that defines the formatting of the date and time. See date-time entity formatting for more details. */
