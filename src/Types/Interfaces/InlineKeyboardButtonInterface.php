...
interface InlineKeyboardButtonInterface extends TypeInterface
{
    ...
    public ?string $callbackData { set; }
    ...
    public ?string $switchInlineQueryCurrentChat { set; }
    ...
    public ?SwitchInlineQueryChosenChatInterface $switchInlineQueryChosenChat { set; }
    ...
    public ?CopyTextButtonInterface $copyText { set; }
    ...
    public ?CallbackGameInterface $callbackGame { set; }
