...
interface UpdateInterface extends TypeInterface
{
    ...
    public ?MessageInterface $editedChannelPost { set; }
    ...
    public ?BusinessMessagesDeletedInterface $deletedBusinessMessages { set; }
    ...
    public ?MessageReactionUpdatedInterface $messageReaction { set; }
    ...
    public ?MessageReactionCountUpdatedInterface $messageReactionCount { set; }

    /** @var InlineQueryInterface|null $inlineQuery Optional. New incoming inline query */
    public ?InlineQueryInterface $inlineQuery { set; }
    ...
    public ?PreCheckoutQueryInterface $preCheckoutQuery { set; }
    ...
    public ?PaidMediaPurchasedInterface $purchasedPaidMedia { set; }
    ...
    public ?PollAnswerInterface $pollAnswer { set; }
    ...
    public ?ChatMemberUpdatedInterface $myChatMember { set; }
    ...
    public ?ChatMemberUpdatedInterface $chatMember { set; }
    ...
    public ?ChatJoinRequestInterface $chatJoinRequest { set; }
    ...
    public ?ChatBoostUpdatedInterface $chatBoost { set; }
    ...
    public ?ChatBoostRemovedInterface $removedChatBoost { set; }
}
