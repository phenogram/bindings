...
interface SuggestedPostPaidInterface extends TypeInterface
{
    ...
    /** @var string $currency Currency in which the payment was made. Currently, one of “XTR” for Telegram Stars or “TON” for TON grams. */
    public string $currency { set; get; }

    /** @var int|null $amount Optional. The amount of the currency that was received by the channel in nanograms; for payments in TON grams only */
