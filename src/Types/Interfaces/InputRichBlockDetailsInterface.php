 ...
 */
interface InputRichBlockDetailsInterface extends TypeInterface
{
    ...
    /** @var bool|null $isOpen Optional. Pass True if the content of the block is visible by default */
