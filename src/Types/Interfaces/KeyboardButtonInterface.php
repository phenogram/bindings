...
{
    /** @var string $text Text of the button. If none of the fields other than text, icon_custom_emoji_id, and style are used, it will be sent as a message when the button is pressed */
    public string $text { set; get; }

    /** @var string|null $iconCustomEmojiId Optional. Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that purchased additional usernames on Fragment or in the messages directly sent by the bot to private, group and supergroup chats if the owner of the bot has a Telegram Premium subscription. */
    public ?string $iconCustomEmojiId { set; get; }

    /** @var string|null $style Optional. Style of the button. Must be one of “danger” (red), “success” (green) or “primary” (blue). If omitted, then an app-specific style is used. */
    ...
    public ?KeyboardButtonRequestUsersInterface $requestUsers { set; get; }
    ...
    public ?bool $requestLocation { set; get; }
    ...
    public ?KeyboardButtonPollTypeInterface $requestPoll { set; get; }
