...
interface KeyboardButtonRequestChatInterface extends TypeInterface
{
    ...
    public ?bool $chatHasUsername { set; }
    ...
    public ?ChatAdministratorRightsInterface $userAdministratorRights { set; }
    ...
    public ?ChatAdministratorRightsInterface $botAdministratorRights { set; }
