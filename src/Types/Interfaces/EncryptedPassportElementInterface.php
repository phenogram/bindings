...
interface EncryptedPassportElementInterface extends TypeInterface
{
    ...
    public ?PassportFileInterface $frontSide { set; }
    ...
    public ?PassportFileInterface $reverseSide { set; }
    ...
    public ?PassportFileInterface $selfie { set; }
