...
interface InputInvoiceMessageContentInterface extends TypeInterface
{
    ...
    public ?string $providerToken { set; }
    ...
    public ?array $suggestedTipAmounts { set; }
    ...
    public ?string $providerData { set; }
    ...
    public ?bool $needPhoneNumber { set; }
    ...
    public ?bool $needShippingAddress { set; }
    ...
    public ?bool $sendPhoneNumberToProvider { set; }
    ...
    public ?bool $sendEmailToProvider { set; }
