 ...
 */
class InlineQueryResultsButton implements Interfaces\InlineQueryResultsButtonInterface
{
    /**
     * @param string                   $text           Label text on the button
     * @param WebAppInfoInterface|null $webApp         Optional. Description of the Web App that will be launched when the user presses the button. The Web App will be able to switch back to the inline mode using the method switchInlineQuery inside the Web App.
