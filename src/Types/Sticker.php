 ...
 */
class Sticker implements Interfaces\StickerInterface
{
    /**
     ...
     * @param PhotoSizeInterface|null    $thumbnail        Optional. Sticker thumbnail in the .WEBP or .JPG format
     ...
     * @param FileInterface|null         $premiumAnimation Optional. For premium regular stickers, premium animation for the sticker
     * @param MaskPositionInterface|null $maskPosition     Optional. For mask stickers, the position where the mask should be placed
    ...
    public function __construct(
        ...
        public ?FileInterface $premiumAnimation = null,
