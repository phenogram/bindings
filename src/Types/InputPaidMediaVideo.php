...
class InputPaidMediaVideo extends InputPaidMedia implements Interfaces\InputPaidMediaVideoInterface
{
     ...
     * @param string|null $cover             Optional. Cover for the video in the message. Pass a file_id to send a file that exists on the Telegram servers (recommended), pass an HTTP URL for Telegram to get a file from the Internet, or pass “attach://<file_attach_name>” to upload a new one using multipart/form-data under <file_attach_name> name. More information on Sending Files »
     * @param int|null    $startTimestamp    Optional. Start timestamp for the video in the message
