...
class GiftInfoFactory extends AbstractFactory
{
     ...
     * @param int|null           $prepaidUpgradeStarCount Optional. Optional. Number of Telegram Stars that were prepaid for the ability to upgrade the gift
     * @param bool|null          $isUpgradeSeparate       Optional. Optional. True, if the gift's upgrade was purchased after the gift was sent
