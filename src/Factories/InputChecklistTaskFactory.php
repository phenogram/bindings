...
class InputChecklistTaskFactory extends AbstractFactory
{
     ...
     * @param array|null  $textEntities Optional. Optional. List of special entities that appear in the text, which can be specified instead of parse_mode. Currently, only bold, italic, underline, strikethrough, spoiler, custom_emoji, and date_time entities are allowed.
     */
