...
class PollAnswerFactory extends AbstractFactory
{
     ...
     * @param array|null         $optionPersistentIds Optional. Persistent identifiers of the chosen answer options. May be empty if the vote was retracted.
     */
    public static function make(
        ...
        ?array $optionPersistentIds = null,
    ): PollAnswerInterface {
        return self::factory()->makePollAnswer(
            ...
            optionPersistentIds: $optionPersistentIds ?? self::fake()->words(self::fake()->numberBetween(1, 5)),
        );
    }
}
