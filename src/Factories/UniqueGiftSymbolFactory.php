...
class UniqueGiftSymbolFactory extends AbstractFactory
{
    /**
     * Creates a new UniqueGiftSymbol instance with default fake data.
     *
     * @param string|null           $name           Optional. Name of the symbol
    ...
    public static function make(
        ...
        return self::factory()->makeUniqueGiftSymbol(
