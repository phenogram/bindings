...
class BotCommandScopeChatMemberFactory extends AbstractFactory
{
     ...
     * @param int|string|null $chatId Optional. Unique identifier for the target chat or username of the target supergroup in the format @username. Channel direct messages chats and channel chats aren't supported.
