...
class InputPollOptionFactory extends AbstractFactory
{
     ...
     * @param \Phenogram\Bindings\Types\Interfaces\InputPollOptionMediaInterface|null $media         Optional. Optional. Media added to the poll option
     */
    public static function make(
        ?string $text = null,
        ?string $textParseMode = null,
        ?array $textEntities = null,
        ?\Phenogram\Bindings\Types\Interfaces\InputPollOptionMediaInterface $media = null,
