...
class SuggestedPostPaidFactory extends AbstractFactory
{
     ...
     * @param string|null              $currency             Optional. Currency in which the payment was made. Currently, one of “XTR” for Telegram Stars or “TON” for TON grams.
     * @param int|null                 $amount               Optional. Optional. The amount of the currency that was received by the channel in nanograms; for payments in TON grams only
