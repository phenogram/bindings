...
class ChatAdministratorRightsFactory extends AbstractFactory
{
     ...
     * @param bool|null $canManageChat       Optional. True, if the administrator can access the chat event log, get boost list, see hidden supergroup and channel members, report spam messages and ignore slow mode. Implied by any other administrator privilege.
     ...
     * @param bool|null $canPostMessages     Optional. Optional. True, if the administrator can post messages in the channel, or access channel statistics; for channels only
